...
brfss = read.csv("../Data/Processed/brfss_2018_2023.rds", header=T)
...
loadPkg("bestglm")
res.bestglm1 <- bestglm(Xy = brfss_3, family = binomial, IC = "AIC", method = "exhaustive")
...
res.bestglm <- bestglm(Xy = brfss_2, family = binomial, IC = "AIC", method = "exhaustive")
summary(res.bestglm)
